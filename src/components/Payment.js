...
function Payment(props) {
    ...
    const productListIdArray = [];
    const quantityListArray = [];
   
    product.items.forEach((element, index, array) => {

        //console.log(index, element.id);
        productListIdArray.push(element.id);
        quantityListArray.push(element.quantity);

        //var elementIdList = (index, element.id)
        //setProductListId(elementIdList)
        
    });

    console.log(productListIdArray);
    console.log(quantityListArray);

    //console.log(productListId);


// var arr1[product.items.length];
...
// }))
    ...
    // const productIdOrdersList = [product.items.length];
    // console.log(productIdOrdersList);
    ...
    const handleSubmit = (e) => {
        ...
        // axios
        //     .post("http://localhost:8045/cradle/payment/save", userData)
        //     .then((response) => {
        //     });
        ...
        axios
            .post("http://localhost:8045/cradle/orders/save", orderData)
            .then((response) => {
        });

       
        axios
            .post("http://localhost:8045/cradle/orders/saveOrdersList")
